...
export const metadata: Metadata = {
  title: "Next.js Avatars | ReclaimAdmin - Next.js Dashboard Template",
  description:
    "This is Next.js Avatars page for ReclaimAdmin - Next.js Tailwind CSS Admin Dashboard Template",
};
