...
export const metadata: Metadata = {
  title: "Next.js Modals | ReclaimAdmin - Next.js Dashboard Template",
  description:
    "This is Next.js Modals page for ReclaimAdmin - Next.js Tailwind CSS Admin Dashboard Template",
  // other metadata
};
